...
const defaults = {
  ...
  engines: {
    text: { binary: `${home}/llama.cpp/build/bin/llama-server`, port: 8080, ngl: 99, ctx: 8192, nCpuMoe: 0, noMmap: false, mlock: false, directIo: false, cacheTypeK: 'f16', cacheTypeV: 'f16', extraArgs: [] },
