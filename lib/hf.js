...
// HF blocks /api/models/{id} from datacenter IPs (401), but the HTML tree page is public.
// Scrape filenames from it instead; sizes are not in the HTML, so they show as unknown.
